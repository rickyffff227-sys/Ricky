...
建立 Ricky Fu 的个人作品集网站，集中展示个人背景、实践经历、能力方向和联系方式。本轮整理前的 README 将用途描述为求职与硕士申请资料展示。网站应让访问者迅速了解其市场研究、消费者洞察与数据分析方向，并能找到具体经历的依据。

## 网站定位

当前是中文为主、英文标签辅助的单页个人介绍与作品集基础版。主叙事是“从经济与贸易出发，理解商业世界”。页面强调个人经历和能力概述；尚未形成带过程、成果和佐证材料的完整案例集，也未发现已配置的线上发布环境。
...
2. 首页 `#top`：视频背景、定位文案、查看经历与了解更多入口。
3. 关于我 `#about`：个人简介、照片占位视觉、身份/城市/邮箱、三项数字指标。
...
1. 请本人确认网站主要服务求职、硕士申请或两者，并核对公开信息、三项数字指标、经历时间与结果表述。
2. 补充至少一项可公开的真实案例材料：问题、本人职责、方法、结果、可展示图片或脱敏证据；据此决定是否增加案例详情。
3. 在目标与材料确认后做桌面和手机实测，处理内容、交互与动效问题，再确定部署平台、域名及上线流程。
4. 将本地 Git 仓库连接到本人选择的远程仓库，形成真正可共享的代码与文档来源。
...
- 主要目标与优先受众是什么？求职、硕士申请是否需要不同版本或入口？
