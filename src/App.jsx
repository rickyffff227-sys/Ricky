...
const profile = {
  ...
  major: '国际经济与贸易', graduation: '2027',
  stage: '本科毕业年级', heroTag: '2027 GRADUATE',
  heroDescription: '国际经济与贸易专业本科生，关注市场研究、消费者洞察与数据驱动的决策。',
}
  ...
  return <>
    ...
    <main>
      <section id="top" className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-content page-width"><div className="hero-kicker"><span className="live-dot" /> OPEN TO OPPORTUNITIES <span className="kicker-divider" /> {profile.heroTag}</div><h1 id="hero-title">用经济学视角<span className="title-comma">，</span><br /><em>理解商业世界。</em></h1><p className="hero-subtitle">你好，我是 {profile.name}。<br />{profile.heroDescription}</p><div className="hero-actions"><a className="button-primary" href="#work">探索我的经历 <Arrow /></a><a className="text-link" href="#about">了解更多 <span>↗</span></a></div></div>
